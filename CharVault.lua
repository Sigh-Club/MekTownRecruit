    ...
    elseif unpacked:sub(1, 5) == "GB:E:" and gbRecvBuf then
        ...
        if senderName ~= MTR.playerName then
            ...
            if ok then
                ...
                MTR.dprint("[GuildBank Sync] Rejected snapshot from", gbRecvSender or senderName, "(stale or hash mismatch)")
            end
        end
        gbRecvBuf    = nil
        gbRecvSender = nil
    ...
    elseif unpacked:sub(1, 5) == "GL:E:" and gblRecvBuf then
        ...
        if senderName ~= MTR.playerName then
            ...
            if ok then
                ...
                MTR.dprint("[Ledger Sync] Rejected ledger snapshot from", senderName, "(stale or hash mismatch)")
            end
        end
        gblRecvBuf = nil
        gblRecvFrom = nil
